...
export interface SeriesHighlight {
     ...
     * color.
     *
     * The border option is supported when [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) is set to
     ...
     *
     * The color option is supported when [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) is set to `"donut"` or `"pie"`.
     */
    color?: string;
    /**
     ...
     *
     * The line option is supported when [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) is set to `"candlestick"` or `"ohlc"`.
     */
    line?: HighlightLine;
    /**
     * The opacity of the highlighted points.
     *
     * The opacity option is supported when [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) is set to `"bubble"`, `"pie"`, or `"donut"`.
     */
    opacity?: number;
    /**
