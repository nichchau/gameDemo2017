...
/**
 * The categoryAxis.crosshair options.
 */
export interface CategoryAxisCrosshair {
     ...
     * The crosshair tooltip is displayed when the [`categoryAxis.crosshair.tooltip.visible`]({% slug api_charts_categoryaxiscrosshairtooltip_kendouiforangular %}#toc-visible) option is set to
     * `true`.
     */
