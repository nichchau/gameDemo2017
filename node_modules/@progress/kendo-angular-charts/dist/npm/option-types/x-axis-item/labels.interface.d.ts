...
export interface XAxisLabels {
     ...
     *
     * The Chart chooses the appropriate format for the current [`xAxis.baseUnit`]({% slug api_charts_xaxis_kendouiforangular %}#toc-baseunit). Setting the
