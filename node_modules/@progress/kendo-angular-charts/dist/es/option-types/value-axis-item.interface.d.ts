...
export interface ValueAxis {
     ...
     * If [`valueAxis.type`]({% slug api_charts_valueaxis_kendouiforangular %}#toc-type) is set to `"log"`, the `majorUnit` value is used for the base of the
     * logarithm.
     */
    majorUnit?: number;
    /**
    ...
    /**
     * The interval between minor divisions. It defaults to 1/5 of the [`valueAxis.majorUnit`]({% slug api_charts_valueaxis_kendouiforangular %}#toc-majorunit).
     * If [`valueAxis.type`]({% slug api_charts_valueaxis_kendouiforangular %}#toc-type) is set to `"log"`, the `minorUnit` value represents the number of divisions
     * between 2 major units and defaults to the major unit minus one.
     */
    minorUnit?: number;
    /**
     * The unique axis name. Used to associate a series with a value axis using the [`series.axis`]({% slug api_charts_series_kendouiforangular %}#toc-axis) option.
     */
    name?: string;
    /**
     ...
     *
     * The crosshair is displayed when the [`valueAxis.crosshair.visible`]({% slug api_charts_valueaxiscrosshair_kendouiforangular %}#toc-visible) option is set to `true`.
     */
     ...
     *
     * To display the title, set the [`valueAxis.title.text`]({% slug api_charts_valueaxistitle_kendouiforangular %}#toc-text) option.
     */
