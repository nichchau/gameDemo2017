...
export interface SeriesLabelsTo {
    ...
    font?: string;
    /**
     * The format of the to labels. Uses [IntlService format]({% slug api_intl_intlservice_kendouiforangular %}#toc-format).
     */
    format?: string;
    /**
    ...
    /**
     * If set to `true`, the Chart displays the series to labels. By default, the Chart series to labels are
     * not displayed.
     */
    visible?: boolean;
}
