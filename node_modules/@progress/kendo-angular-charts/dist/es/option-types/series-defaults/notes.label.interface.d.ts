...
/**
 * The series.defaultsNotesLabel options.
 */
export interface SeriesDefaultsNotesLabel {
    ...
    rotation?: number;
    /**
     * If set to `true`, the Chart displays the [`seriesDefaults`]({% slug api_charts_seriesdefaults_kendouiforangular %}) notes label.
     * By default, the [`seriesDefaults`]({% slug api_charts_seriesdefaults_kendouiforangular %}) notes label is visible.
     */
    visible?: boolean;
}
