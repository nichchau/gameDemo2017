...
/**
 * The series.defaultsLabels options.
 */
export interface SeriesDefaultsLabels {
     ...
     *
     * The Chart displays the series labels when either the [`seriesDefaults.labels.visible`]({% slug api_charts_seriesdefaultslabels_kendouiforangular %}#toc-visible) or
     * the [`seriesDefaults.labels.from.visible`]({% slug api_charts_seriesdefaultslabelsfrom_kendouiforangular %}#toc-visible) option is set to `true`.
     */
     ...
     *
     * The Chart displays the series labels when either the [`seriesDefaults.labels.visible`]({% slug api_charts_seriesdefaultslabels_kendouiforangular %}#toc-visible) or
     * the [`seriesDefaults.labels.to.visible`]({% slug api_charts_seriesdefaultslabelsto_kendouiforangular %}#toc-visible) option is set to `true`.
     */
