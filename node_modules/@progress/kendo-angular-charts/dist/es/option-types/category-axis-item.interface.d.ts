...
/**
 * The categoryAxis options.
 */
export interface CategoryAxis {
    /**
     * The time interval steps to use when either `baseUnit` is set to `"fit"` or `"auto"`.
     *
     ...
     * - `"years"`
     *
     * Setting `baseUnit` to `"fit"` sets such a base unit and [`categoryAxis.baseUnitStep`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-baseunitstep)
     * that the total number of categories does not exceed [`categoryAxis.maxDateGroups`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-maxdategroups).
     *
     * Series data is aggregated for the specified base unit by using the [`series.aggregate`]({% slug api_charts_series_kendouiforangular %}#toc-aggregate) function.
     */
    baseUnit?: CategoryBaseUnit;
    /**
     * The step (interval) between the categories in base units. Setting it to `"auto"` sets the step to such
     * a value that the total number of categories does not exceed [`categoryAxis.maxDateGroups`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-maxdategroups).
     *
     * This option is ignored if [`categoryAxis.baseUnit`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-baseunit) is set to `"fit"`.
     */
     ...
     * Can be overridden by [`categoryAxis.labels.color`]({% slug api_charts_categoryaxislabels_kendouiforangular %}#toc-color) and [`categoryAxis.line.color`]({% slug api_charts_axisline_kendouiforangular %}#toc-color).
     */
    color?: string;
    /**
     ...
     *
     * This option is ignored if the [`series.type`]({% slug api_charts_series_kendouiforangular %}#toc-type) option is set to `"bar"`, `"column"`, `"boxPlot"`, `"ohlc"`,
     ...
     * This is often used in combination with the [`categoryAxis.min`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-min) and
     * [`categoryAxis.roundToBaseUnit`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-roundtobaseunit) options to set up a fixed date range.
     */
    max?: any;
    /**
     * The maximum number of groups (categories) to display when
     * [`categoryAxis.baseUnit`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-baseunit) is set to `"fit"` or
     * [`categoryAxis.baseUnitStep`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-baseunitstep) is set to `"auto"`.
     */
    maxDateGroups?: number;
    /**
     * The first date displayed on a date category axis or the index of the first category displayed on a category axis.
     * By default, the min value is the same as the first category.
     * This is often used in combination with the [`categoryAxis.max`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-max) and
     * [`categoryAxis.roundToBaseUnit`]({% slug api_charts_categoryaxis_kendouiforangular %}#toc-roundtobaseunit) options to set up a fixed date range.
     */
    min?: any;
    /**
    ...
    /**
     * The unique axis name. Used to associate a series with a category axis using the [`series.categoryAxis`]({% slug api_charts_series_kendouiforangular %}#toc-categoryaxis)
     * option.
     */
    name?: string;
    /**
     ...
     *
     * The crosshair is displayed when the [`categoryAxis.crosshair.visible`]({% slug api_charts_categoryaxiscrosshair_kendouiforangular %}#toc-visible) option is set to `true`.
     */
     ...
     *
     * To display the title, set the [`categoryAxis.title.text`]({% slug api_charts_categoryaxistitle_kendouiforangular %}#toc-text) option.
     */
